 ...
 * @author keeeeeent
 */
public class Base64ReceiveDataType extends AbstractBaseDataType implements BaseDataType<ByteBuffer> {
	 ...
	 */
	public Base64ReceiveDataType(ByteBuffer baseData) {
		String base64 = null;
	 ...
	 * @param baseData 変換前データ
	 */
	public Base64ReceiveDataType(byte[] baseData) {
		String base64 = null;
		if (Objects.nonNull(baseData)) {
	 ...
	 */
	public Base64ReceiveDataType(String baseData, boolean transform) {
		String base64 = null;
		if (Objects.nonNull(baseData)) {
			if (transform) {
