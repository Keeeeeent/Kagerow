...
/**
 * Kagerow専用仮想DB生成実装クラスです
 * 
 * @author keeeeeent
 */
public non-sealed class BasicVirtualFileCreater extends AppVirtualFileCreater implements KagerowVirtualFileCreater {
	 ...
	 */
	public BasicVirtualFileCreater(
