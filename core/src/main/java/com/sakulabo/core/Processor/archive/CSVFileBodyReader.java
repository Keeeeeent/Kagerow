...
/**
 * CSVファイルのボディ読み取り実装提供クラスです
 * 
 * @author keeeeeent
 */
public class CSVFileBodyReader extends KagerowFileBodyReader {
	 ...
	 */
	protected CSVFileBodyReader(Path path, Charset charset, boolean isHeader) throws IOException {
