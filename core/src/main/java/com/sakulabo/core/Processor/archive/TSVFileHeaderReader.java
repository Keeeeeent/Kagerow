...
/**
 * TSVファイルのヘッダー読み取り実装提供クラスです
 * 
 * @author keeeeeent
 */
public class TSVFileHeaderReader extends KagerowFileHeaderReader {
	 ...
	 */
	TSVFileHeaderReader(Path path, Charset charset, boolean isHeader) throws IOException {
