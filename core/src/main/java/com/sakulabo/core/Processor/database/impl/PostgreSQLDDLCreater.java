...
/**
 * PostgreSQLモード向けのDDLを生成します
 * 
 * @author keeeeeent
 */
public final class PostgreSQLDDLCreater extends DDLCreater {

	/**
	 * デフォルトコンストラクタ
	 * @param dataSet データ構造体
	 */
	public PostgreSQLDDLCreater(DataSet dataSet) {
		super(dataSet);
	}
	...
	public String isBOOLEAN() {
		String colName = dataSet.columnList()[index++];
		String definition = " BOOLEAN DEFAULT FALSE";
		return colName.concat(definition);
	}
