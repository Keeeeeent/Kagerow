package com.sakulabo.library.csv;
 ...
 * @author keeeeeent
 */
@KagerowPlugin(name = "KagerowCSVPlugin", types = { PluginType.INPUT, PluginType.OUTPUT })
public final class CSVDefaultPlugin extends DefaultPlugin implements PluginAdapter {
	...
	public void input(Map<String, String> params, KagerowDBMode mode, Connection connection) {
		...
		FileDefaultInputer inputer = new FileDefaultInputer(
				KagerowFileReaderFactory.newCSVFileReaderFactory(),
				inputPath,
				isHeader,
				initDDL,
				tableName,
