...
public class MySQLInfoAccesserImplTest extends BaseTest<MySQLInfoAccesserImpl> {
	 ...
	 * デフォルトコンストラクタ
	 */
	protected MySQLInfoAccesserImplTest() {
		super(MySQLInfoAccesserImplTest.class);
	}
	...
	public void Test001() throws Throwable {
		...
		// テスト対象生成
		AppDBInfoAccesser testTarget = new MySQLInfoAccesserImpl();
