...
public class OracleDDLCreaterTest extends BaseTest<OracleDDLCreater> {
	 ...
	 * デフォルトコンストラクタ
	 */
	protected OracleDDLCreaterTest() {
		super(OracleDDLCreaterTest.class);
	}
	...
	public void Test001() throws Throwable {
		...
		String exp = """
				...
				col5 TIMESTAMP DEFAULT LOCALTIMESTAMP,\
				col6 NUMBER(1) DEFAULT 0,\
		...
		// テスト対象初期化
		testTarget = new OracleDDLCreater(dataSet);
		// テスト実行
