...
public class TEXTDefaultPluginTest extends BaseTest<TEXTDefaultPlugin> {
	...
	/** テスト対象 */
	@InjectMocks
	protected TEXTDefaultPlugin testTarget;
	...
	public void Test001() throws Throwable {
		...
		// データ準備
		Path resultFile = getOutputPath("Test001.txt");
	...
	public void Test002() throws Throwable {
		...
		// データ準備
		Path resultFile = getOutputPath("Test002.txt");
		Map<String, String> params = new HashMap<>();
		params.put("OutputPath", resultFile.toString());
		params.put("KsqlId", "test");
	...
	public void Test003() throws Throwable {
		...
		// データ準備
		Path testPath = getOutputPath("Test008/Test.txt");
		Map<String, String> params = new HashMap<>();
